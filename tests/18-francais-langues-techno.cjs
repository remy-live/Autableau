...
module.exports = async function (browser) {
    ...
    // LA VOIX INSTALLÉE A ÉTÉ ESSAYÉE, PUIS RETIRÉE.
    //
    // On avait posé toute la plomberie d'une voix Piper rangée dans le
    // navigateur — stockage, détection, choix, retrait, repli propre — et
    // vingt et une vérifications pour l'éprouver. L'essai grandeur nature a
    // tranché : « je trouve cela encore hyper mécanique », puis « je ne suis
    // pas convaincu », puis « retire l'installation de la voix ».
    //
    // Soixante-dix-huit mégaoctets à télécharger pour descendre au-dessous de
    // ce qu'une voix améliorée du système donne gratuitement : le lecteur les
    // classe déjà en premier et dit déjà où les trouver. On ne garde pas une
    // machinerie que plus rien ne mène nulle part — un bouton « Installer une
    // voix… » qui déçoit est une impasse de plus dans une interface qu'on
    // passe son temps à en débarrasser.
    //
    // Ce qui a été appris reste écrit dans « docs/voix-piper.md », et la page
    // d'essai « docs/essai-voix-piper.html » permet de refaire le test sans
    // rien réinstaller, si quelqu'un veut un jour reprendre la question.
