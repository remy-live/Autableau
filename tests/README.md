...
| `15-documents.cjs` | ouvrir un cours écrit ailleurs : .docx (compressé) et .odt (stocké) lus sans bibliothèque, titres / gras / italique / listes / tableau à plat, Markdown et texte brut, encodage Windows rattrapé, blocs posés en colonnes et coupés aux titres, fichier illisible sans dégât, le Ctrl+V depuis Word ou LibreOffice qui pose un bloc de texte sur le tableau (feuille de style jetée, Ctrl+Maj+V pour le texte seul), et le PDF feuilletable posé en un seul objet dont on tourne les pages |
